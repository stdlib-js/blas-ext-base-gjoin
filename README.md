...
```javascript
gjoin = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gjoin@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/blas-ext-base-gjoin/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/blas-ext-base-gjoin/actions/workflows/test.yml?query=branch:v0.1.1
